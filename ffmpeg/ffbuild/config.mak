...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/root/ffmpeg_build --pkg-config-flags=--static --extra-cflags=-I/root/ffmpeg_build/include --extra-ldflags=-L/root/ffmpeg_build/lib --extra-libs='-lpthread -lm' --ld=g++ --bindir=/root/bin --enable-gpl --enable-gnutls --enable-libaom --enable-libass --enable-libfdk-aac --enable-libfreetype --enable-libmp3lame --enable-libopus --enable-libsvtav1 --enable-libvorbis --enable-libvpx --enable-libx264 --enable-libx265 --enable-nonfree
...
CC_IDENT=gcc 12 (Debian 12.2.0-14)
ARCH=aarch64
INTRINSICS=neon
EXTERN_PREFIX=
CC=gcc
...
CFLAGS=  -I/root/ffmpeg_build/include -std=c17 -fomit-frame-pointer -fPIC    -pthread  -I/usr/include/p11-kit-1 -I/root/ffmpeg_build/include -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/harfbuzz -I/usr/include/glib-2.0 -I/usr/lib/aarch64-linux-gnu/glib-2.0/include -I/usr/include/fribidi -I/usr/include/libdrm -I/root/ffmpeg_build/include -I/usr/include/freetype2 -I/usr/include/libpng16 -I/usr/include/opus -I/usr/include/opus -I/usr/include/svt-av1 -DEB_DLL -UEB_DLL       -DX264_API_IMPORTS        -I/usr/include/libdrm    -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -I/usr/include/SDL2 -D_REENTRANT
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCCFLAGS=  
ASFLAGS=  -I/root/ffmpeg_build/include -fPIC -g
...
WINDRES=windres
DOXYGEN=doxygen
LDFLAGS= -L/root/ffmpeg_build/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,-rpath-link=:libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil
LDEXEFLAGS=
LDSOFLAGS=
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -latomic -ldrm -lm -lxcb -lXau -lXdmcp -lxcb-shm -lxcb -lXau -lXdmcp -lxcb-shape -lxcb -lXau -lXdmcp -lxcb-xfixes -lxcb -lXau -lxcb-render -lxcb -lXau -lxcb-shape -lxcb -lXau -lXdmcp -lasound -lm -ldl -lpthread -lrt -lSDL2 -lm -lasound -lm -ldl -lpthread -lpulse-simple -lpulse -pthread -lsamplerate -lX11 -lXext -lXcursor -lXi -lXfixes -lXrandr -lXss -ldrm -lgbm -lwayland-egl -lwayland-client -lwayland-cursor -lxkbcommon -ldecor-0 -lpthread -lrt -lsndio -lXv -lX11 -lpthread -lxcb -lXau -lXext -lX11 -lpthread -lxcb -lXau -lXdmcp -lX11 -lpthread -lxcb -lXau -lXdmcp -lXext -lX11 -lpthread -lxcb -lXau -lXdmcp
EXTRALIBS-avfilter=-pthread -lm -latomic -lass -lm -lfontconfig -lfreetype -lz -lm -lz -lm -lz -lbrotlicommon -lexpat -lm -lharfbuzz -pthread -lm -lz -lm -lz -lm -lz -lbrotlicommon -lgraphite2 -lglib-2.0 -pthread -lm -lpcre2-8 -lfribidi -lfreetype -lz -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon -lva -lfreetype -lz -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon
EXTRALIBS-swscale=-lm -latomic
EXTRALIBS-postproc=-lm -latomic
EXTRALIBS-avformat=-lm -latomic -lz -lgnutls -lgmp -lunistring -latomic -lnettle -lhogweed -lgmp -lnettle -ltasn1 -lidn2 -lunistring -lp11-kit
EXTRALIBS-avcodec=-lvpx -lm -lm -lpthread -lvpx -lm -lm -lpthread -lvpx -lm -lm -lpthread -lvpx -lm -lm -lpthread -pthread -lm -latomic -L/root/ffmpeg_build/lib -laom -lm -L/root/ffmpeg_build/lib -lfdk-aac -lm -lmp3lame -lm -lopus -lm -lSvtAv1Enc -lpthread -lm -lvorbis -lm -logg -lvorbisenc -lvorbis -lm -logg -lx264 -lpthread -lm -ldl -lx265 -lstdc++ -lm -lgcc_s -lgcc -lgcc_s -lgcc -lrt -ldl -lnuma -lz -lva
EXTRALIBS-swresample=-lm -latomic
EXTRALIBS-avutil=-pthread -lva-drm -lva -lva-x11 -lva -lvdpau -lX11 -lm -ldrm -lm -lva -latomic -lX11 -lpthread -lxcb -lXau -lXdmcp
EXTRALIBS-ffplay=-lSDL2 -lm -lasound -lm -ldl -lpthread -lpulse-simple -lpulse -pthread -lsamplerate -lX11 -lXext -lXcursor -lXi -lXfixes -lXrandr -lXss -ldrm -lgbm -lwayland-egl -lwayland-client -lwayland-cursor -lxkbcommon -ldecor-0 -lpthread -lrt
EXTRALIBS-ffprobe=
EXTRALIBS-ffmpeg=
